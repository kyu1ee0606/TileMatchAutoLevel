...
| Grass | `grass` | 1~2번 제거 필요 | ✅ |

### 연결 기믹
| 기믹 | 코드 | 설명 | 봇 지원 |
|------|------|------|---------|
| Link East | `link_e` | 동쪽 연결 | ✅ |
| Link West | `link_w` | 서쪽 연결 | ✅ |
| Link South | `link_s` | 남쪽 연결 | ✅ |
| Link North | `link_n` | 북쪽 연결 | ✅ |

### 이동/변환 기믹
| 기믹 | 코드 | 설명 | 봇 지원 |
|------|------|------|---------|
| Frog | `frog` | 랜덤 점프 | ⚠️ 확률적 |
| Teleport | `teleport` | 워프 이동 | ✅ |
| Curtain | `curtain` | 열고 닫힘 | ✅ |
